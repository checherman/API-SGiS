...
use Input;
use DB; 
use App\Models\Catalogos\TiposRedesSociales;
/**
* Controlador Acción
* 
...
* @created    2015-07-20
*
* Controlador `TiposRedesSociales`: Esto es un ejemplo
*
*/
class TipoRedSocialController extends Controller {
	 ...
	 * </Ul>
	 *
	 * TiposRedesSociales ordenamiento con respecto a id:
	 * <code>
	...
	public function index(){
		...
		if(array_key_exists('pagina', $datos)){	
			...
			if(array_key_exists('buscar', $datos)){
				...
				$valor   = $datos['valor'];
				$data = TiposRedesSociales::orderBy($order,$orden);
				...
				$data = TiposRedesSociales::skip($pagina-1)->take($datos['limite'])->orderBy($order, $orden)->get();
				$total = TiposRedesSociales::all();
			}
			
		}
		else{
			$data = TiposRedesSociales::all();
			$total = $data;
		}
	...
	public function update($id){
        ...
        DB::beginTransaction();
        try{
        	$data = TiposRedesSociales::find($id);
